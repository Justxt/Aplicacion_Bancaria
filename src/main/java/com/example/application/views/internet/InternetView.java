package com.example.application.views.internet;
...
@PageTitle("Internet")
@Route(value = "internet")
public class InternetView extends VerticalLayout {

    private NumberField montoPagarField;

    public InternetView() {
        setClassName("internet-view");
        ...
        H2 titulo = new H2("Pago Internet");
        add(titulo);
        ...
        pagBot.addClickListener(e -> pagarInternet());
